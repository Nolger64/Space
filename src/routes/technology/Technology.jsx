...
import { useScreen } from "../../hooks/useScreen"; // import custom hook
...
const Technology = () => {
  const width = useScreen().width; // custom hook
    ...
    return (
      <>
        ...
        >
          ...
          <h1 className={style.TechTittleDes}>
            {data.technology[selected].name}
          </h1>
          <p className={style.TechDes}>
      ...
      <>
        {width < 1000 ? (
          ...
          <motion.img
            ...
            src={imgTechnologyPort[selected]}
            className={style.TechImg}
          />
        )}
      </>
  ...
  return (
    <div className={style.ContainerTechnolgy}>
      <div className={style.Technolgy}>
        <div className="">
          <h1 className={style.TechnolgyTittle}>
            <p className={style.TechnolgySubtittle}>03</p>space launch 101
          </h1>
        </div>
